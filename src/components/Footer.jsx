        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
              ...
              <ul className="space-y-3 text-[13px]">
                {studioLinks.map(item => (
                  <li key={item.labelKey}>
                    <Link to={item.path} className="link-underline text-white/80 hover:text-teal-400">{t.nav[item.labelKey]}</Link>
                  </li>
                ))}
                <li>
                  <Link to="/iletisim" className="link-underline text-white/80 hover:text-teal-400">{t.nav.contact}</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-[13px]">
                {t.services.items.slice(0, 4).map(s => (
                  <li key={s.t}><Link to="/tedaviler" className="link-underline text-white/80 hover:text-teal-400">{s.t}</Link></li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-[13px] text-white/80">
                ...
                <li><a href="tel:+902121234567" className="link-underline hover:text-teal-400">+90 212 123 45 67</a></li>
                <li><a href="mailto:info@auradental.studio" className="link-underline hover:text-teal-400">info@auradental.studio</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-[13px]">
                {t.footer.social.map(x => (
                  <li key={x}><a href="#" className="link-underline text-white/80 hover:text-teal-400">{x}</a></li>
                ))}
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-[11px] text-white/40 tracking-wider">
            ...
            <div className="flex items-center gap-6">
              <Link to="/sss" className="link-underline hover:text-teal-400">{t.footer.privacy}</Link>
              <a href="#" className="link-underline hover:text-teal-400">{t.footer.kvkk}</a>
