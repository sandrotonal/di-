    ...
    <>
      <style>{`
        ...
        .shiny-cta {
          ...
          --shiny-cta-fg: #ffffff;
          --shiny-cta-highlight: #4a78e0;
          --shiny-cta-highlight-subtle: #769bf2;
        ...
        .shiny-cta span::before {
          ...
          animation: 4.5s breathe linear infinite;
        }
        ...
        .shiny-cta:hover, .shiny-cta:hover::before, .shiny-cta:hover::after,
        .shiny-cta:focus-visible, .shiny-cta:focus-visible::before, .shiny-cta:focus-visible::after {
          animation-play-state: running;
        }
        .shiny-cta:hover span::before, .shiny-cta:focus-visible span::before { opacity: 1; }
